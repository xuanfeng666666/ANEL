...
# 创建结果目录
result_dir = 'GDELT_k_9_12_15_REGCN_ANEL_result'
...
for i, params in enumerate(param_combinations):
    ...
    with open(out_log, 'w') as o_f:
        cmd = (
            f"python main.py -d GDELT --densify_k {params['densify_k']} --basic_model_weight {params['basic_model_weight']} --train-history-len 7 --test-history-len 7 --dilate-len 1 "
