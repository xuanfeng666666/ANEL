...
# 创建结果目录
result_dir = 'without_degree_05_15_k9_REGCN_ANEL_result'
...
for i, params in enumerate(param_combinations):
    ...
    with open(out_log, 'w') as o_f:
        cmd = (
            f"python main.py -d ICEWS05-15 --densify_k {params['densify_k']} --basic_model_weight {params['basic_model_weight']} --train-history-len 15 --test-history-len 15 --dilate-len 1 "
